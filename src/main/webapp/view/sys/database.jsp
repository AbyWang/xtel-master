...
<body style="margin: 40px">
	<form id="formobj" action="jeecgListDemoController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
		...
		<div class="form-group">
			<label for="name" class="col-sm-3 control-label">数据库地址\端口：</label>
			<div class="col-sm-7">
				<div class="input-group" style="width:48%">
					<input type="text" class="form-control input-sm required" id="name"  name="name" data-msg-required="" datatype="*" placeholder="请输入账号密码" aria-required="true" />
				</div>
		...
		<div class="form-group">
			<label class="col-sm-3 control-label">数据库账号\密码：</label>
			<div class="col-sm-7">
