...
$(function () {
    ...
    var table = new BSTable("roleList",path+ "/user/getRoleWithPage", defaultColunms);
    table.init();
});
...
roleList.initColumn= function () {
    return [
        {title: '用户id',field: 'USERID', align: 'center', valign: 'middle',width:'50px'},
        {title: '用户名称', field: 'NAME', align: 'center', valign: 'middle',width:'50px'}]
  };
</script>
</body>
</html>
