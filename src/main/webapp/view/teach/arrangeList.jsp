...
$(function () {
    ...
    var table = new BSTable("arrangelist",path+ "/teachingController/getCourseArrangePage", defaultColunms);
    table.init();
});
...
arrangelist.initColumn= function () {
    return [
     ...
     {title: '操作', align: 'center', valign: 'middle',width:'50px', formatter: 
    		            ...
    		            return "<button class='btn btn-xs btn-info' onclick=''><i class='icon-edit bigger-180'></i>通过审核</button>&nbsp;"
    		        }}]
